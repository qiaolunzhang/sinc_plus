...
if __name__ == '__main__':
    physical_topology = "german-modified"
    num_physical_nodes = 7
    ...
    # (1,2) (1,7) (2,3) (2,6) (2,7) (3,4) (3,6) (4,5) (4,6) (5,6) (6,7) (1,3) (5,7)
    physical_link_list = [(1, 2), (1, 7), (2, 3), (2, 6), (2, 7), (3, 4), (3, 6), (4, 5), (4, 6), (5, 6), (6, 7),
                          (1, 3), (5, 7)]
    # num_virtual_network_list = [6, 12, 18, 24, 30]
    num_virtual_network_list = [2, 3, 4, 5, 6]
    num_virtual_nodes = 5
        ...
        for i in range(1, 11):
            ...
            for j in range(num_virtual_link_min, num_virtual_link_max+1):
                ...
                with open(file_name, "w") as file:
                    ...
                    file.write("param n := 7;\n\n")

                    file.write("set E := (1,2) (1,7) (2,3) (2,6) (2,7) (3,4) (3,6) (4,5) (4,6) (5,6) (6,7) (1,3) (5,7) ;\n\n")
