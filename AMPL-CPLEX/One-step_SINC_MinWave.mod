...
# minimum number of wavelengths. This network scenario requires to respect
# this minimum value
param min_wave;
...
#Number of wavelengths constraint
s.t. maxNumberOfWavelengths:
	sum{(i,j) in A, (v,s,t) in Btot} q[i,j,v,s,t]<=min_wave;
...
#VN need sharing only if at least one of its cut-sets is down
...
# Problem that jointly applies SVNM and SINC
problem SVNMGW4: qa,q,g,av,p,pa,f,f2,r,nh,nh2,csd,sh, Availability, flow,flow1,flow2,flow3,flow4,flow5,flow6,bidirectionality,bidirectionality2, survivability,maxNumberOfWavelengths,affectedVirLinks,affectedVirLinks2,flowvirtual,flowvirtual1,flowvirtual2,flowvirtual3,flowvirtual4,flowvirtual5,flowvirtual6,flowvirtualSameVL,sameVNRouting,sameVNRouting2,sameVNRouting3,cutsetDown,cutsetDown2,virtNetNeedSharing,virtNetNeedSharing2,limitSharing,virReqUseFailVirLink,virReqUseFailVirLink1,virReqUseFailVirLink2,virReqUseFailVirLink3,virReqUseFailVirLink4,virtNetDown,virtNetDown2,cutsetGeneralVNDown,cutsetGeneralVNDown2,reduceTimeAvailability;

# SVNM problem
problem SVNM: qa,q,TWC, flow,flow1,flow2,flow3,flow4,flow5,flow6,bidirectionality,bidirectionality2, survivability;
